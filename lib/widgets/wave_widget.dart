...
import 'package:login_ui/widgets/clipper_widget.dart';
...
List <Offset> wavePoints = [];
  ...
  void initState() {
    ...
    super.initState();
      ...
      final double fulSphere = animationController.value * Math.pi *2;
      final double normalizer = Math.cos(fulSphere);
